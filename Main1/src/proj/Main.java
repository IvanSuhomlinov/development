...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            System.out.print("Введите номер мед.полиса: ");
            String snilsId = scanner.nextLine();
            person.setPolis(snilsId);
            persons.add(person);
        }

        for (Person person : persons) {
            System.out.println("Фамилия: " + person.getLastName());
            System.out.println("Номер мед.полиса: " + person.getPolis());
        ...
        System.out.println("Люди по фамилии: " + searchLastName + ":");
